...
import { useDeleteCarMutation } from "@/libs/store/reducers/carsApi";
...
const Car = ({ car }) => {
  ...
  const [deleteCar, { isSuccess, isLoading, isError }] = useDeleteCarMutation();
  ...
  const navigateToEdit = ({ id }) => {
    router.push(`/admin/cars/update/${id}`);
  };
    ...
    <div className={styles.catalogCars__item}>
      ...
      <div className={styles.item__right}>
        ...
        <div className={styles.item__bottom}>
          <button
            ...
            onClick={() => navigateToEdit({ id: car?.id })}
          >
            Изменить
          </button>
          <button className={styles.item__delete} onClick={handleDeleteClick}>
            Удалить
          </button>
        </div>
      </div>
      ...
      <Dialog open={openDialog} onClose={handleDeleteCancel}>
        ...
        <DialogActions>
          ...
          <Button
            onClick={() => handleDeleteConfirm({ id: car?.id })}
            autoFocus
          >
            Удалить
          </Button>
